(function ($) {
    ...
    document.querySelector("#one_month").addEventListener('click', function (e) {
        ...
        chart.updateOptions({
            xaxis: {
                min: new Date('20 Nov 2021').getTime(),
                max: new Date('19 Dec 2021').getTime(),
            }
        })
    })
    ...
    document.querySelector("#six_months").addEventListener('click', function (e) {
        ...
        chart.updateOptions({
            xaxis: {
                min: new Date('20 Nov 2021').getTime(),
                max: new Date('19 May 2022').getTime(),
            }
        })
    })
    ...
    document.querySelector("#one_year").addEventListener('click', function (e) {
        ...
        chart.updateOptions({
            xaxis: {
                min: new Date('20 Nov 2021').getTime(),
                max: new Date('19 Nov 2022').getTime(),
            }
        })
    })
    ...
    document.querySelector("#ytd").addEventListener('click', function (e) {
        ...
        chart.updateOptions({
            xaxis: {
                min: new Date('20 Nov 2021').getTime(),
                max: new Date('19 Jan 2022').getTime(),
            }
        })
    })
    ...
    function generateDayWiseTimeSeries(s, count) {
        ...
        var i = 0;
        var series = [];
        var x = new Date("19 Jan 2022").getTime();
        while (i < count) {
